...
class EventHandler():
    ...
    def __handle_gpio_events(self):
        self.__handle_gpio_press(2, self.incr_corp_credits)
        self.__handle_gpio_press(3, self.decr_corp_credits)
        self.__handle_gpio_press(4, self.incr_corp_handsize)
        self.__handle_gpio_press(5, self.decr_corp_handsize)
        self.__handle_gpio_press(6, self.incr_corp_bad_pub)
        self.__handle_gpio_press(7, self.decr_corp_bad_pub)
        self.__handle_gpio_press(8, self.incr_runner_credits)
        self.__handle_gpio_press(9, self.decr_runner_credits)
        self.__handle_gpio_press(10, self.incr_runner_handsize)
        self.__handle_gpio_press(11, self.decr_runner_handsize)
        self.__handle_gpio_press(12, self.incr_runner_tags)
        self.__handle_gpio_press(13, self.decr_runner_tags)
        self.__handle_gpio_press(14, self.incr_runner_brain_dmg)
        self.__handle_gpio_press(15, self.decr_runner_brain_dmg)
        self.__handle_gpio_press(16, self.incr_runner_mem_units)
        self.__handle_gpio_press(17, self.decr_runner_mem_units)
        self.__handle_gpio_press(18, self.incr_runner_agenda_pnt)
        self.__handle_gpio_press(19, self.decr_runner_agenda_pnt)
        self.__handle_gpio_press(20, self.incr_corp_agenda_pnt)
        self.__handle_gpio_press(21, self.decr_corp_agenda_pnt)
        self.__handle_gpio_press(22, self.runner_click_track)
        self.__handle_gpio_press(23, self.corp_click_track)
